...
if (LINUX OR DARWIN)
  if(${CMAKE_C_COMPILER} MATCHES "gcc*")
    set(UNIX_WARNINGS "-Wall -Wno-trigraphs")
    set(UNIX_CXX_WARNINGS "${UNIX_WARNINGS} -Wno-reorder -Wno-non-virtual-dtor -Woverloaded-virtual")
  elseif(${CMAKE_C_COMPILER} MATCHES "clang*")
    set(UNIX_WARNINGS "-Wall -Wno-trigraphs -Wno-tautological-compare -Wno-char-subscripts -Wno-gnu -Wno-logical-op-parentheses -Wno-non-virtual-dtor")
